...
def run_keywords_entities() -> None:
    ...
    # Top 5 tópicos
    for col, (dest, dlabel, dcolor) in enumerate(zip(Params.DEST_ORDER, Params.DEST_LABELS, Params.DEST_COLORS)):
    ...
    for col, (dest, dlabel) in enumerate(zip(Params.DEST_ORDER, Params.DEST_LABELS)):

...
PATH_PROJ = Paths.CLUSTERING_EMBEDDINGS_DIR / "proyeccion_2d.npy"
PATH_ETIQ = Paths.CLUSTERING_EMBEDDINGS_DIR / "etiquetas_mejores.json"
...
def run_topic_graph() -> None:
    ...
    patches = [mpatches.Patch(color=COLORS[c], label=f"C{c}: {cluster_names[c]}") for c in range(8)]
